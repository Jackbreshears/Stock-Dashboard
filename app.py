...
def render_portfolio():
    ...
    with tab_az:
        ...
        if not port_az:
            ...
            if not api_key_az:
                st.info("🔑 Add your Anthropic API key in the **sidebar** (bottom of the left panel) to enable the portfolio analyzer.")
            else:
...
def render_stock(ticker: str):
    ...
    with tab_ai:
        ...
        if not api_key:
            st.info("🔑 Add your Anthropic API key in the **sidebar** (bottom of the left panel) to enable AI analysis.")
